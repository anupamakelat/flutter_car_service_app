...
class AcceptDriverAdapter extends TypeAdapter<AcceptDriver> {
  @override
  final int typeId = 10;

  @override
  AcceptDriver read(BinaryReader reader) {
  ...
  @override
  void write(BinaryWriter writer, AcceptDriver obj) {
    writer
      ..writeByte(13)
      ..writeByte(0)
      ..write(obj.id)
