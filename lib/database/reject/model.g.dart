...
class RejectDataAdapter extends TypeAdapter<RejectData> {
  @override
  final int typeId = 7;

  @override
  RejectData read(BinaryReader reader) {
  ...
  @override
  void write(BinaryWriter writer, RejectData obj) {
    writer
      ..writeByte(8)
      ..writeByte(0)
      ..write(obj.id)
